			...
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
					...
					<nav id="menu" class="pull-right">
						<ul>
							<li><a href="{$GET_PROD}">Woman</a>					
								<ul>
									<li><a href="{$GET_PROD}">Lacinia nibh</a></li>									
									<li><a href="{$GET_PROD}">Eget molestie</a></li>
									<li><a href="{$GET_PROD}">Varius purus</a></li>									
								</ul>
							</li>															
							<li><a href="{$GET_PROD}">Man</a></li>			
							<li><a href="{$GET_PROD}">Sport</a>
								<ul>									
									<li><a href="{$GET_PROD}">Gifts and Tech</a></li>
									<li><a href="{$GET_PROD}">Ties and Hats</a></li>
									<li><a href="{$GET_PROD}">Cold Weather</a></li>
								</ul>
							</li>							
							<li><a href="{$GET_PROD}">Hangbag</a></li>
							<li><a href="{$GET_PROD}">Best Seller</a></li>
							<li><a href="{$GET_PROD}">Top Seller</a></li>
						</ul>
					</nav>
				</div>
			</section>				
