						...
						<table class="table table-striped">
							...
							<tbody>
								<tr>
									...
									<td><a href="#"><img alt="" src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMP']->value;?>
/themes/images/ladies/9.jpg"></a></td>
								...
								<tr>
									<td><input type="checkbox" value="option1"></td>
									<td><a href="#"><img alt="" src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMP']->value;?>
/themes/images/ladies/1.jpg"></a></td>
								...
								<tr>
									<td><input type="checkbox" value="option1"></td>
									<td><a href="#"><img alt="" src="<?php echo $_smarty_tpl->tpl_vars['GET_']->value;?>
/themes/images/ladies/3.jpg"></a></td>
...
>
			$(document).ready(function() {
				$('#checktout').click(function (e) {
					document.location.href = "<?php echo $_smarty_tpl->tpl_vars['GET_HOME']->value;?>
/checkout";
				})
			});
		<?php echo '</script'; ?>
